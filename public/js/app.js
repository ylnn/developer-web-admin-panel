...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__routes__ = __webpack_require__(37);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vue_wysiwyg__ = __webpack_require__(57);
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.use(__WEBPACK_IMPORTED_MODULE_3_vue_wysiwyg___default.a, {}); // config is optional. more below
// vue wysiwyg 
      ...
      _c("div", { staticClass: "row justify-content-center" }, [
        _c("div", { staticClass: "col-md-12" }, [
          _c("div", { staticClass: "card card-default" }, [
            ...
            _vm._v(" "),
            _c("div", { staticClass: "card-body" }, [_vm._v("Home Detail")])
          ])
        ])
      ])
    ])
...
Component.options.__file = "resources/assets/js/views/variables/Variables.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-ccbe8e48", Component.options)
  } else {
    hotAPI.reload("data-v-ccbe8e48", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        get_all: function get_all() {
            var self = this;
            axios.get('/api/manage/variables/all').then(function (_ref) {
                var data = _ref.data;
                return self.contents = data.data;
            });
        },
        ...
        create_and_get_id: function create_and_get_id() {
            var self = this;
            axios.post('/api/manage/variables/create').then(function (response) {
        ...
        edit: function edit(id) {
            var self = this;
            axios.get('/api/manage/variables/edit/' + id).then(function (response) {
        ...
        remove: function remove(id) {
            var self = this;
            axios.delete('/api/manage/variables/delete/' + id).then(function (response) {
                self.get_all();
            });
        },
...
var render = function() {
  ...
  return _c("div", { staticClass: "container" }, [
    _c("div", { staticClass: "row justify-content-center" }, [
      _c("div", { staticClass: "col-md-12" }, [
        _c("div", { staticClass: "card card-default" }, [
          _c("div", { staticClass: "card-header" }, [_vm._v("Variables")]),
          _vm._v(" "),
                                ...
                                _c("div", { staticClass: "row" }, [
                                  _c("div", { staticClass: "col-md-4 mb-3" }, [
                                    ...
                                    _c("input", {
                                      ...
                                      domProps: { value: _vm.inputKey },
                                      on: {
                                        input: function($event) {
                                          if ($event.target.composing) {
                                            return
                                          }
                                          _vm.inputKey = $event.target.value
                                        }
                                      }
                                    })
                                  ]),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-ccbe8e48", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/views/portfolios/Portfolios.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-fe3c5ce8", Component.options)
  } else {
    hotAPI.reload("data-v-fe3c5ce8", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        get_all: function get_all() {
            var self = this;
            axios.get('/api/manage/portfolios/all').then(function (_ref) {
                var data = _ref.data;
                return self.contents = data.data;
            });
        },
...
var render = function() {
  ...
  return _c("div", { staticClass: "container" }, [
    _c("div", { staticClass: "row justify-content-center" }, [
      _c("div", { staticClass: "col-md-12" }, [
        _c("div", { staticClass: "card card-default" }, [
          _c("div", { staticClass: "card-header" }, [_vm._v("Portfolios")]),
          _vm._v(" "),
          _c("div", { staticClass: "card-body" }, [
            _c("div", { staticClass: "pb-1" }, [
              _c(
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-fe3c5ce8", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/views/images/Images.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5d6057ec", Component.options)
  } else {
    hotAPI.reload("data-v-5d6057ec", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        remove: function remove(id) {
            var self = this;
            axios.delete('/api/manage/images/delete/' + id).then(function (response) {
                self.get_all();
...
var render = function() {
  ...
  return _c("div", { staticClass: "container" }, [
    _c("div", { staticClass: "row justify-content-center" }, [
      _c("div", { staticClass: "col-md-12" }, [
        _c("div", { staticClass: "card card-default" }, [
          _c("div", { staticClass: "card-header" }, [_vm._v("Images")]),
          _vm._v(" "),
          _c("div", { staticClass: "card-body" }, [
            _c(
              "div",
              {
                staticClass: "pb-1 d-flex columns",
                ...
                _c("div", { staticClass: "pl-3" }, [
                  _c(
                    "div",
                    {
                      ...
                      staticClass: "alert alert alert-warning"
                    },
                    [
                      _vm._v(
                        "\n                                " +
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-5d6057ec", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/views/articles/Articles.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3092e14c", Component.options)
  } else {
    hotAPI.reload("data-v-3092e14c", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        get_all: function get_all() {
            var self = this;
            axios.get('/api/manage/articles/all').then(function (_ref) {
                var data = _ref.data;
                return self.contents = data.data;
            });
        },
        ...
        remove: function remove(id) {
            var self = this;
            axios.delete('/api/manage/articles/delete/' + id).then(function (response) {
                self.get_all();
            });
        }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-3092e14c", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/views/articles/ArticleDetail.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-29d1b130", Component.options)
  } else {
    hotAPI.reload("data-v-29d1b130", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        create_and_get_id: function create_and_get_id() {
            var self = this;
            axios.post('/api/manage/articles/create').then(function (response) {
                self.form.id = response.data.id;
            });
        },
        ...
        getRemoteSelectedPhotos: function getRemoteSelectedPhotos() {
            var self = this;
            axios.get('/api/manage/articles/images/' + self.form.id).then(function (response) {
                // console.log(response.data);
                self.selectedPhotos = response.data;
            }).catch(function (error) {
                return console.log('remote images error');
...
var render = function() {
  ...
  return _c("div", { staticClass: "container" }, [
    _c("div", { staticClass: "row justify-content-center" }, [
      _c("div", { staticClass: "col-md-12" }, [
        _c("div", { staticClass: "card card-default" }, [
          _c("div", { staticClass: "card-header" }, [_vm._v("Article Detail")]),
          _vm._v(" "),
          _c("div", { staticClass: "card-body" }, [
            _c("div", [
              _c(
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-29d1b130", module.exports)
  }
}
